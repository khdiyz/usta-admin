...
function ServiceCreatePage() {
    ...
    const fetchCategories = async () => {
      try {
        ...
        showModal({
          type: 'error',
          title: 'Xatolik',
          message: `Kategoriyalarni yuklashda xatolik yuz berdi: ${err.message}`,
        });
      } finally {
        setLoading(false);
      }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      showModal({
        type: 'error',
        title: 'Xatolik',
        message: `Xizmat yaratishda xatolik yuz berdi: ${err.message}`,
      });
  ...
  return (
    <div className="p-6 max-w-lg mx-auto bg-white shadow-md rounded">
      <h1 className="text-2xl font-semibold text-gray-800 mb-6">Yangi Xizmat Qo'shish</h1>
